# training script from https://github.com/UKPLab/sentence-transformers/blob/master/examples/training/ms_marco/train_bi-encoder-v2.py
...
data_folder = '/ivi/ilps/personal/svakule/msmarco'
model_save_path = '/ivi/ilps/personal/svakule/msmarco/output/training_ms-marco_bi-encoder-'+model_name.replace("/", "-")+'-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
